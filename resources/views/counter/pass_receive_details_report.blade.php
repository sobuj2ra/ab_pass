...
<!--Page Title-->
@section('page-title')
    Passport Receive  Details Report
@endsection
                    ...
                    <div class="main_part">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="table_view" style="padding: 10px">
                                ...
                                <h4 align="center">Passport Receive Details Report </h4>
                                    ...
                                    <table width="50%"  class="table-bordered table" style="font-size: 15px;">
                                        ...
                                        @foreach($getData_list as $data_item)
                                            <tr class="odd gradeX">
                                                ...
                                                <td>{{ $data_item->Applicant_name }}</td>
                                                <td>{{ $data_item->WebFile_no }}</td>
                                                <td>{{ $data_item->Passport }}</td>
                                                <td>{{ $data_item->service_by }}</td>
                                                <td>{{ date('d-m-Y h:i:s A', strtotime($data_item->Service_Date)) }}</td>
                                            </tr>
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Passport Receive  Details Report</i>
                        </p>
                        <form action="{{ URL::to('passport-receive-details-report') }}" method="post">
                            {{ csrf_field() }}
