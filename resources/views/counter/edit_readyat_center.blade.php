                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="" value="{{$readyEditData->Passport}}" id="contactNoId" class="form-control" disabled="disabled">
                                        </div>
                                        <div class="form-group">
                                            <label for="contactNoId">Received By:</label>
                                            <input type="text" name="ReadyCenterby" value="{{$readyEditData->ReadyCenterby}}" id="contactNoId" class="form-control" disabled="disabled">
                                        </div>
                                        <div class="form-group">
                                            <label for="serviceDateId">Received Date:</label>
                                            <input type="text" name="ReadyCentertime" value="{{Date('d-m-Y',strtotime(@$readyEditData->ReadyCentertime))}}" class="form-control datepicker" disabled="disabled">
                                        </div>
                                    </div>
