...
<!--Page Title-->
@section('page-title')
    Delivery Center Failed Details Report
@endsection
                    ...
                    <div class="main_part">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="table_view" style="padding: 10px">
                                ...
                                <h4 align="center">Delivery Center Failed Details Report</h4>
                                    ...
                                    <table width="50%"  class="table-bordered table" style="font-size: 15px;">
                                        ...
                                        @foreach($getData_list as $data_item)
                                            <tr class="odd gradeX">
                                                ...
                                                <td>{{ $data_item->del_by }}</td>
                                                <td>{{ $data_item->DelRemark }}</td>
                                                <td>{{ date('d-m-Y', strtotime($data_item->del_time)) }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Delivery Center Failed Details Report</i>
                        </p>
                        <form action="{{ URL::to('delivery-center-failed-details-report') }}" method="post">
                            {{ csrf_field() }}
