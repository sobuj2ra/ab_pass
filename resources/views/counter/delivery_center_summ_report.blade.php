...
<!--Page Title-->
@section('page-title')
    Delivery Center Summary Report
@endsection
                    ...
                    <div class="main_part">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="table_view" style="padding: 10px">
                                ...
                                <h4 align="center">Delivery Center Summary Report </h4>
                                ...
                                <div class="panel-body">
                                    <table width="50%"  class="table-bordered table" style="font-size: 15px;">
                                        ...
                                        @endforeach
                                        @foreach($getDelData_list as $data_item)
                                            <tr class="odd gradeX">
                                                <td>Failed</td>
                                                <td><?php $total+= $data_item->id_count; echo $data_item->id_count; ?></td>
                                            </tr>
                                        @endforeach
                                        <tfooter>
                                            <th>Total Data</th>
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Delivery Center Summary Report</i>
                        </p>
                        <form action="{{ URL::to('delivery-center-summary-report') }}" method="post">
                            {{ csrf_field() }}
