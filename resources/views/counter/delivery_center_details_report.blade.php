...
<!--Page Title-->
@section('page-title')
    Delivery Center Details Report
@endsection
                    ...
                    <div class="main_part">
                        ...
                        <div id="printableArea">
                            ...
                            <div class="table_view" style="padding: 10px">
                                ...
                                <h4 align="center">Delivery Center Details Report </h4>
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Delivery Center Details Report</i>
                        </p>
                        <form action="{{ URL::to('delivery-center-details-report') }}" method="post">
                            {{ csrf_field() }}
