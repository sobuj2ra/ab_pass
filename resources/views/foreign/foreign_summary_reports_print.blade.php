...
<!--Page Header-->
@section('page-header')
    Foreign Passport Summary Report
@endsection
                ...
                <div class="main_part">
                    <div class="row">
                        ...
                        <div class="col-md-1" style="padding: 0px;">
                            <a href="{{URL::to('/foreign-summary/1/'.$user_id.'/'.$from.'/'.$to)}}"><button style="padding: 7px 22px;margin:10px;" type="button" class="btn btn-primary pull-right">CSV</button></a>
                        </div>
                        <div class="col-md-1" style="padding: 0px;">
                            <a href="{{URL::to('/foreign-summary/2/'.$user_id.'/'.$from.'/'.$to)}}"><button style=" padding: 7px 22px;margin:10px;" type="button" class="btn btn-primary pull-right">EXCEL</button></a>
                        </div>
                        <div class="col-md-1" style="padding: 0px;">
                            <a href="{{URL::to('/foreign-summary/3/'.$user_id.'/'.$from.'/'.$to)}}"><button style="padding: 7px 22px;margin:10px;" type="button" class="btn btn-primary pull-right">PDF</button></a>
                        </div>
                    ...
                    <div id="printableArea">
                        <style type="text/css" media="print">
                            @page { size: landscape;font-size: 14px;
                            }
                        </style>
                        <div class="table_view" style="padding: 10px">
                            <h3 align="center">INDIAN VISA APPLICATION CENTRE</h3>
                            <h4 align="center">Foreign Passport Summary Report</h4>
