...
@section('page-content')
                    ...
                    <div class="form-group">
                        <select class="form-control" name="stickerType" id="stickerType" required="required">
                            ...
                            @foreach($sticker as $sticker_value)
                                <option @php if($sticker_value->sticker=="$stype") { @endphp selected="selected"
                                        @php } @endphp value="{{$sticker_value->sticker}}">{{$sticker_value->sticker}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group"><input class="form-control" id="fromstk" value="{{$sfrom}}"
                                                   name="stickerfrom" placeholder="From" required="required"></div>
                </div>
                <div class="col-sm-1" style="padding:0;text-align: center;">To</div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <input class="form-control" id="tostk" name="stickerto" value="{{$sto}}" placeholder="To"
                               required="required">
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($routes as $routes_value)
                            <ul class="list-group" style="margin:0;padding: 0;">
                                <li style="list-style-type:none;padding:0;margin:0;">
                                    <label style="font-weight:normal;cursor: pointer;"><input type="checkbox" id="eport"
                                                                                              name='eport'
                            ...
                            <ul class="list-group" style="margin:0;padding: 0;">
                                <li style="list-style-type:none;padding:0;margin:0;">
                                    <label style="font-weight:normal;cursor: pointer;"> <input type="checkbox"
                                                                                               id="areaport"
                                                                                               name="areaport"
                                                                                               value="{{$port_value->port_name}}"/> {{$port_value->port_name}}
                                    </label>
                                </li>
                            </ul>
                        @endforeach
                        ...
                        @foreach ($mode as $mode_value)
                            <ul class="list-group" style="margin:0;padding: 0;">
                                <li style="list-style-type:none;padding:0;margin:0;">
                                    <label style="font-weight:normal;cursor: pointer;"> <input type="checkbox"
                                                                                               id="modeid" name="mode"
                                                                                               value="{{$mode_value->mode}}"/> {{$mode_value->mode}}
                                    </label>
                                </li>
                            </ul>
                        @endforeach
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-6"><b>Arrival Date</b> <br/><input type="date" name="arrivalDate" id="dt"
                                                                      class="form-control margintop5"
                                                                      onchange="mydate1();" required="required"/></div>
                <div class="col-sm-6"><b>Departure Date</b><br/> <input type="date" name="derpartureDate" id="dt"
                                                                        class="form-control margintop5"
            ...
            <div class="row">
                <div class="col-md-2">
                    <div style="float:left;width:42px;margin-top:5px;"><label style="font-weight:normal;"> <input
                                    type="radio" id="dnd" value="1" name="master_passport"> M.P</label></div>
                    <div style="float:right;width:100px;"><input type="text" id="v1" name="passportNo[]"
                                                                 class="form-control mpass_val" required="required"
                ...
                <div class="col-md-2" style="padding-left:0;"><input type="text" required="required" name="contactNo[]"
    ...
    <div class="copy hide">
        <div class="control-group input-group" id="temp" style="border-top:1px dashed #ccc;margin-top:15px;">
            <div class="row" style="margin-top:15px;">
                <div class="col-md-2">
                    <div style="float:left;width:42px;margin-top:5px;"><label style="font-weight:normal;"> <input
                                    type="radio" value="1" id="nID" name="master_passport" class="sRow"> M.P</label>
                    </div>
                    <div style="float:right;width:100px;"><input type="text" name="passportNo[]" id="nID2"
                                                                 class="form-control mpass_val" placeholder="P.P. No">
                    </div>
                </div>
                <div class="col-md-1" style="padding:0;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group-btn" style="text-align: right;">
                        <button class="btn btn-danger remove margintop15" type="button" style="border-radius:4px;"><i
    ...
    <div class="modal fade" id="submit_confirm" tabindex="-1" role="dialog" aria-labelledby="submit_confirmTitle"
         aria-hidden="true">
...
<div id="printableArea" style="display: none;">
    @php if(!empty(rappapController::slip_print($printid))) { @endphp
    @foreach ( rappapController::slip_print($printid) as $val)
...
// });
                ...
                if ($('input[type=radio][name=master_passport]:checked').length == 0) {
                    alert("Please select M.P (Masster Passport)");
