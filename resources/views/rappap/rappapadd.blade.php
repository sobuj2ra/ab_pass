                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group"><input class="form-control" id="fromstk" value="{{$sfrom}}"
                                                           name="stickerfrom" placeholder="From" required="required"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input class="form-control" id="tostk" name="stickerto" value="{{$sto}}"
                            ...
                            <div class="form-group">
                                <select class="form-control" name="visaType[]">
                                    ...
                                    @foreach($visatype as $visatype_value)
                                        <option
                                            <?php if($visatype_value->visa_type == 'TOURIST') { ?> selected="selected"
                                            <?php } ?>  value="{{$visatype_value->visa_type}}">{{$visatype_value->visa_type}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2" style="padding-left:0;"><input type="text" pattern=".{10}"
                                                                             title="Minimum  & Maximum 10 digit"
                                                                             required="required"
                                                                             name="contactNo[]"
            ...
            <div class="copy hide">
                <div class="control-group input-group" id="temp"
                    ...
                    <div class="row" style="margin-top:15px;">
                        ...
                        <div class="col-md-2" style="padding-left:0;"><input id="contID" pattern=".{10}"
                                                                             title="Minimum  & Maximum 10 digit"
...
<div id="printableArea" style="display: none;">
    ...
    <table border=0 width="100%" class="tclass" style="padding: 0">
        ...
        <tr>
            <td colspan=2 class="text-center">
                <div class="centerdiv2">
                    <center>R.A.P./P.A.P. Application</center>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan=2 style='margin: 105px 0'>
                ...
                <?php $c_date = date('Y-m-d');  ?>
                <strong>Delivery on or after: {{$val->tdd}}</strong>
    ...
    <table border=0 width="100%" class="tclass" style="padding: 0">
        ...
        <tr>
            ...
            <td><span class="pull-right" style="float: right;">@php echo date("h:i:s A"); @endphp</span></td>
        </tr>
        <tr>
            <td colspan=2 style='margin: 105px 0'>
                <div class="topborder"></div>
