                    ...
                    <div class="row">
                        <div class="col-md-4 change_passport_body"
                            ...
                            <p class="form_title_center bg-info">
                                <i>-Delete R.A.P. / P.A.P-</i>
                            </p>
                            {!! Form::open(['url' => 'rappap/delete-search','id' => 'applicant_form']) !!}
                                    ...
                                    <div class="row">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $deleteData->center;  ?></td>
                                                <td><?php echo $deleteData->visa_no;  ?></td>
                                                <td><?php echo $deleteData->visa_type;  ?></td>
                                                <td><?php echo $deleteData->entry_by;  ?></td>
                                                <td><?php echo date('d-m-Y', strtotime($deleteData->created_at));  ?></td>
                                                <td><a href="{{URL::to('/delete-rappap/'.$deleteData->serial_no)}}"><button type="button" class="btn btn-block btn-default">Delete</button></a> </td>
                                            </tr>
                                            <?php } ?>
