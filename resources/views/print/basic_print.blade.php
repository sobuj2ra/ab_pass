...
@section('page-content')
    <div id="printableArea" class="container container-fluid" style="background: #fff">
        <div class="row">
            <div class="col-md-12">
                <h5><b><span style="float: left;">No. DAC/VISA/406/14/2019</span><span style="float: right">{{$currentDate}}</span></b></h5>
            </div>
        </div>
        <div>
            <h4 class="col-md-10" align="center"><b>RESTRICTED / PROTECTED AREA PERMIT</b></h4>
            <h4 class="col-md-10" align="center"><b>(BASIC PRINT - {{$currentDate}})</b></h4>
        </div>
        ...
        <div class="col-md-10 col-xs-offset-">
            <p class="col-xs-offset-1"> (a)&nbsp;&nbsp; Photography of Vulnerable areas / Vulnerable Points including
                sensitive Army installations / equipment is not permitted.</p>
            <p class="col-xs-offset-1"> (b)&nbsp;&nbsp;The applicant should not participate in discussions on any
        ...
        <div class="col-md-10">
            ...
            <ul>
                ...
                <li>The permit is valid for the specific tourist circuit / route and the specific entry / exit point.
    ...
    <div class="pull-left" style="margin-right: 15px;padding-left: 56px;"><input type="button" class="search btn btn-primary" onclick="printDiv('printableArea')" value="Print"/></div>
    @endsection
    ...
    <script type="text/javascript">
        function printDiv(printableArea) {
            ...
            location.replace("{{URL::to('/hci/basic/print')}}");
        }
    </script>
