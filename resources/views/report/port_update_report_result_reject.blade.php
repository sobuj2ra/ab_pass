...
@section('page-title')
    ...
    @endsection
            ...
            <!--Page Header-->
@section('page-header')
    R.A.P. / P.A.P. Reject Detail Report
    @endsection
		...
		<div class="col-md-12">
			<div class="main_part">
				...
				<div class="table_view" id="printableArea" style="padding: 10px">
					<h3 align="center">R.A.P./P.A.P. Reject Summary Report</h3>
					...
					{
					$sql = "SELECT COUNT(`approve_status`) as total FROM tbl_port_update WHERE CAST(`approve_date` AS DATE) = '$form_date' AND `approve_status` = 'Rejected' ";
