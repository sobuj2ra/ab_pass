...
<!--Page Header-->
@section('page-header')
    Foreign Passport Del2App Summary Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Foreign Passport Del2App Summary Report</i>
                        </p>
                        <form action="{{ URL::to('foreign-del-app-summary-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id">
                                    ...
                                    <option value="{{$user->del2appby}}">{{$user->del2appby}}</option>
                                    <?php } ?>
