...
<!--Page Header-->
@section('page-header')
    Delete Del2App & Ready Centre Port Endorsement
@endsection
                ...
                <!-- Code Here.... -->
                    <div class="row">
                        <div class="col-md-4 change_passport_body"
                            ...
                            {!! Form::open(['url' => 'del2app/port/delete-search','id' => 'applicant_form']) !!}
                                    ...
                                    <div class="row">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{URL::to('/delete-port/delready/'.$type.'/'.$deleteData->serial_no)}}">
