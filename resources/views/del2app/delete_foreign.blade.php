...
<!--Page Header-->
@section('page-header')
    Delete Del2App & Ready Centre Foreign Passport
@endsection
                ...
                <!-- Code Here.... -->
                    <div class="row">
                        <div class="col-md-4 change_passport_body"
                            ...
                            {!! Form::open(['url' => 'del2app/foreign/delete-search','id' => 'applicant_form']) !!}
                                    ...
                                    <div class="row">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($type == 'del2app'){ ?>
                                                <td><?php echo $deleteData->del2appby;  ?></td>
                                                <td><?php echo date('d-m-Y', strtotime($deleteData->del2apptime));  ?></td>
                                                 <?php }else{ ?>
                                                <td><?php echo $deleteData->readycenterby;  ?></td>
                                                <td><?php echo date('d-m-Y', strtotime($deleteData->readycentertime));  ?></td>
                                                <?php } ?>

                                                <td><a href="{{URL::to('/delete-foreign/delready/'.$type.'/'.$deleteData->id)}}">
