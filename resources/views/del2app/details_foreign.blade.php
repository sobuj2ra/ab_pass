...
<!--Page Header-->
@section('page-header')
    Foreign Passport Del2App Details Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Foreign Passport Del2App Details Report</i>
                        </p>
                        <form action="{{ URL::to('foreign-del-app-details-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
