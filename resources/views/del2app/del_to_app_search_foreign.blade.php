...
@section('page-content')
                ...
                <div class="main_part">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form action="{{route('/update-del-to-app' )}}" method="POST">
                                        {{ csrf_field() }}
                                        ...
                                        <div id="color" style="padding-top: 5px;background: #5ab587">
                                            <div class="entry" style="margin-left: 120px; width: 800px">
                                                <input type="hidden" id="rsearch" name="rss">

                                                <input type="text" id="colorTextbox1" name="wf_no[]" placeholder="Passport Number" class="webfile_no">
                                                <input name="radioBtn1" id="radioB1" class="rbtn" type="radio" />
                                                <input id="radioBtn1" type="text" class="radioB1 hidden" name="gd_number[]" />
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document.body).on('keydown', '.webfile_no,.radioB1', function (event) {
                var key = event.charCode || event.keyCode || 0;
                var res = $("#rsearch").val();
                var type = 'Foreign Passport';
                ...
                if (key == 13) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            // $('#' + member_no).show();
                            // $('#' + st_type).show();
                            document.getElementById(sr_no).value = data.result.id;
                        }
                    ...
                    newTextBoxDiv.after().html(
                        '<input type="text" name="wf_no[]" style="margin-top: 5px; " placeholder="Passport Number" class="webfile_no" id="colorTextbox' + colorCounter + '" value="" ><input name="radioBtn' + colorCounter + '" id="radioB' + colorCounter + '" type="radio" class="rbtn" />\n' +
                        '                                                <input id="radioBtn' + colorCounter + '" type="text" class="radioB1 hidden" name="gd_number[]" /><input type="hidden" style="width: 50px; display: none" name="name[]" class="ap_name" id="ApName' + colorCounter + '">' +
            ...
            $(document.body).on('click', ".rbtn", function (event) {
                thisRadio = $(this);
                var dd= thisRadio.prop('name');
                ...
                if (thisRadio.hasClass("imChecked")) {
                    ...
                    // document.getElementsByClassName(dd).classList.remove("hidden");
