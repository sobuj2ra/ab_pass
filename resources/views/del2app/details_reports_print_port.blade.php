...
<!--Page Header-->
@section('page-header')
    Port Endorsement Del2App Detail Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div id="printableArea">
                        ...
                        <div class="table_view" style="padding: 10px">
                            ...
                            <h4 align="center">Port Endorsement Del2App Detail Report</h4>
                            ...
                            <div class="panel-body">
                                <table width="100%"  class="table-bordered table" style="font-size: 12px;">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$detail->del2app_by}}</td>
                                        <td><?php echo date('d-m-Y', strtotime($detail->del2app_time)); ?></td>
                                    </tr>
