                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form action="{{route('/update-del-to-app' )}}" method="POST">
                                        ...
                                        <div id="color" style="padding-top: 5px;background: rgba(236, 154, 154, 0.87)">
            ...
            $(document.body).on('keydown', '.webfile_no,.radioB1', function (event) {
                ...
                if (key == 13) {
                    ...
                    newTextBoxDiv.after().html(
                        '<input type="text" name="wf_no[]" style="margin-top: 5px; " placeholder="Passport Number" class="webfile_no" id="colorTextbox' + colorCounter + '" value="" ><input name="radioBtn' + colorCounter + '" id="radioB' + colorCounter + '" type="radio" class="rbtn" /><input id="radioBtn' + colorCounter + '" type="text" class="radioB1 hidden" name="gd_number[]" /><input type="hidden" style="width: 50px; display: none" name="name[]" class="ap_name" id="ApName' + colorCounter + '">' +
