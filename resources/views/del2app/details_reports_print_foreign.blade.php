...
<!--Page Header-->
@section('page-header')
    Foreign Passport Del2App Detail Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div id="printableArea">
                        ...
                        <div class="table_view" style="padding: 10px">
                            ...
                            <h4 align="center">Foreign Passport Del2App Detail Report</h4>
                                ...
                                <table width="100%"  class="table-bordered table" style="font-size: 12px;">
                                    ...
                                    <?php foreach($print_data as $detail){ $i=1; ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>{{$detail->del2appby}}</td>
                                            <td><?php echo date('d-m-Y', strtotime($detail->del2apptime)); ?></td>
                                        </tr>
