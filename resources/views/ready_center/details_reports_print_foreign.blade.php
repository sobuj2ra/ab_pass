...
<!--Page Header-->
@section('page-header')
    Foreign Passport Ready Centre Detail Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div id="printableArea">
                        ...
                        <div class="table_view" style="padding: 10px">
                            ...
                            <h4 align="center">Foreign Passport Ready Centre Detail Report</h4>
                            ...
                            <div class="panel-body">
                                <table width="100%"  class="table-bordered table" style="font-size: 12px;">
                                    ...
                                    <tr>
                                        <th>SL</th>
                                        <th>Passport</th>
                                        <th>Ready Centre By</th>
                                        <th>Ready Centre Date</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$detail->readycenterby}}</td>
                                        <td><?php echo date('d-m-Y', strtotime($detail->readycentertime)); ?></td>
                                    </tr>
