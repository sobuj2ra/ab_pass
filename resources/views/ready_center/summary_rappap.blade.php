...
<!--Page Title-->
@section('page-title')
    R.A.P./P.A.P. Summary Report
@endsection

<!--Page Header-->
@section('page-header')
    R.A.P./P.A.P. Ready Centre Summary Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i> R.A.P./P.A.P. Ready Centre Summary Report</i>
                        </p>
                        <form action="{{ URL::to('rappap-ready-center-summary-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
