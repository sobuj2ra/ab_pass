...
<!--Page Header-->
@section('page-header')
    Foreign Passport Ready Centre Summary Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Foreign Passport Ready Centre Summary Report</i>
                        </p>
                        <form action="{{ URL::to('foreign-ready-center-summary-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id">
                                    ...
                                    <option value="{{$user->readycenterby}}">{{$user->readycenterby}}</option>
                                    <?php } ?>
