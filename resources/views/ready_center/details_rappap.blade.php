...
<!--Page Title-->
@section('page-title')
    R.A.P/P.A.P Del2App Details Report
@endsection

<!--Page Header-->
@section('page-header')
    R.A.P/P.A.P Ready Centre Details Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>R.A.P/P.A.P Ready Centre Details Report</i>
                        </p>
                        <form action="{{ URL::to('rappap-ready-center-details-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_id">
                                    ...
                                    <option value="{{$user->ready_cen_by}}">{{$user->ready_cen_by}}</option>
                                    <?php } ?>
