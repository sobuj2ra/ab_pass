...
<!--Page Header-->
@section('page-header')
    Port Endorsement Ready Centre Details Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Port Endorsement Ready Centre Details Report</i>
                        </p>
                        <form action="{{ URL::to('port-ready-center-details-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
