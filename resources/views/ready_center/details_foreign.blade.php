...
<!--Page Title-->
@section('page-title')
    Foreign Passport Details Report
@endsection

<!--Page Header-->
@section('page-header')
    Foreign Passport Ready Centre Details Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Foreign Passport Ready Centre Details Report</i>
                        </p>
                        <form action="{{ URL::to('foreign-ready-center-details-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
