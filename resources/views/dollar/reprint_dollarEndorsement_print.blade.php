...
@section('page-content')
            ...
            <table  width="100%">
                ...
                <tr>
                    <td style="font-size: 11px;padding: 0px !important;margin: 0px !important;" width="33%">
                        ...
                        <p style="margin: 5px !important;" >Date of Travel: <span style="border: 1px solid #ddd;padding-right: 100px;padding-left: 3px"><?php echo date('d-m-Y', strtotime($print_data->travel_date)) ?></span></p>
                    ...
                    <td style="font-size: 12px;padding: 5px; height: 600px !important;" width="33%">
                        ...
                        <br>
                        <hr style="padding: 0px 0px 0px 0px; width: 50% !important;margin: 0px;line-height: 0.8em"> Signature of the Authorized official
                        </p>
    ...
    <script>
        ...
        $(window).on('afterprint', function () {
            window.location.href="{{ url("/reprint-dollar-endorsement") }}";
        });
        <?php } ?>
    </script>
    <script>
