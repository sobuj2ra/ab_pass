                        ...
                        <div class="col-md-12 change_passport_body" style="width: 100%">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12" style="border: 1px solid #ddd; padding: 10px;background: #f7f7f7">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <input class="form-control" name="c_rate" id="rate" value="<?php echo $editData->c_rate; ?>"  placeholder="Current Dollar Rate">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="datepicker form-control" name="created_date" data-date-format="dd/mm/yyyy" autocomplete="off" disabled value="<?php echo date('d-m-Y', strtotime($editData->created_date)); ?>">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <select class="form-control" name="branch_name" required>
                                                            <option value="<?php echo $editData->branch_name; ?>"><?php echo $editData->branch_name; ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <input class="form-control" name="serial_number" placeholder="Serial Number" value="<?php echo $editData->serial_number; ?>" autocomplete="off" type="text" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control" id="currency_name" name="c_type" required>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" id="foregin_currency" required name="f_currency" placeholder="amount in foreign currency" autocomplete="off" value="<?php echo $editData->f_currency ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <label>Commission</label>
                                                    <div class="form-group">
                                                        <input class="form-control" id="commission" name="" placeholder="Commission (USD)" disabled autocomplete="off" value="<?php echo $editData->commission ?>">
                                                        <input class="form-control" id="commission2" name="commission" autocomplete="off" type="hidden" value="<?php echo $editData->commission ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" required value="<?php echo $editData->passport_no ?>" id="passport" name="passport_no" placeholder="Passport Number" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="datepicker form-control" data-date-format="dd/mm/yyyy" value="<?php echo date('d-m-Y', strtotime($editData->date_of_issue)) ?>" name="date_of_issue" id="entry_date" autocomplete="off" placeholder=" Date of Issue Passport" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="datepicker form-control" data-date-format="dd/mm/yyyy" value="<?php echo date('d-m-Y', strtotime($editData->expire_date)) ?>" name="expire_date" id="expire_date" autocomplete="off" placeholder="Expiry Date of Passport" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="place_of_issue" value="<?php echo $editData->place_of_issue ?>" placeholder="Place of Issue Passport" autocomplete="off" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" required id="applicant_name" name="a_name" placeholder="Name of the applicant" autocomplete="off" value="<?php echo $editData->a_name ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" required name="a_mobile" value="<?php echo $editData->a_mobile ?>" id="mobile_number" pattern=".{10}" title="Minimum & Maximum 10 digit" placeholder="Mobile Number " autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="urn" value="<?php echo $editData->urn ?>" placeholder="URN" pattern=".{10}" title="Minimum & Maximum 10 digit" autocomplete="off" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="digit" value="<?php echo $editData->digit ?>" placeholder="Travel Card Number" pattern=".{4}" title="Minimum & Maximum 4 digit" autocomplete="off" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="a_maiden_name" value="<?php echo $editData->a_maiden_name ?>" placeholder="Mother's Maiden Name" autocomplete="off" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="datepicker form-control" data-date-format="dd/mm/yyyy" value="<?php if($editData->a_birth != 0000-00-00){ echo date('d-m-Y', strtotime($editData->a_birth)); }  ?>" name="a_birth" id="date" autocomplete="off" placeholder="Applicant's Date of Birth" >
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12" style="border: 1px solid #ddd;padding: 10px">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" value="<?php if ($editData->a_phone == 0){ }else{ echo $editData->a_phone; }  ?>" name="a_phone" pattern=".{10}" id="phone" placeholder="Phone" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="e_name" value="<?php echo $editData->e_name ?>" pattern=".{10}" placeholder="Name of the Person to Contact" autocomplete="off" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="e_relation" value="<?php echo $editData->e_relation ?>" placeholder="Relationship  with the Applicant" autocomplete="off" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="e_phone" pattern=".{10}" value="<?php if ($editData->e_phone == 0){ }else{ echo $editData->e_phone; } ?>" pattern=".{10}" id="e_phone" placeholder="Phone number" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" pattern=".{10}" name="e_phone1" value="<?php if ($editData->e_phone1 == 0){ }else{ echo $editData->e_phone1; } ?>" id="phone_11" placeholder="Phone 1" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" pattern=".{10}" name="e_phone2" value="<?php if ($editData->e_phone2 == 0){ }else{ echo $editData->e_phone2; } ?>" id="phone_22" placeholder="Phone 2" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="e_address_2" rows="4" placeholder="Business/Office Name & Address of the Card Holder"><?php echo $editData->e_address_2 ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="e_city_2" value="<?php echo $editData->e_city_2 ?>" placeholder="City" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="e_pin_2" value="<?php echo $editData->e_pin_2 ?>" placeholder="PIN" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" pattern=".{10}" name="e_phone_3" value="<?php if ($editData->e_phone_3 == 0){ }else{ echo $editData->e_phone_3; } ?>" id="phone_33" placeholder="Phone 1" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" pattern=".{10}" name="e_phone_extn" value="<?php if ($editData->e_phone_extn == 0){ }else{ echo $editData->e_phone_extn; } ?>" id="phone_44" placeholder="Extn" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="cheque_amount" value="<?php echo $editData->cheque_amount ?>" placeholder="Cheque Amount" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="sbl_ca_account_no" value="<?php echo $editData->sbl_ca_account_no ?>" placeholder="Debi SBI/CA Account No" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input class="form-control" name="sbl_ca_amount"  value="<?php echo $editData->sbl_ca_amount ?>" placeholder="Amount BDT" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="col-md-3">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" name="s_e_name[]" value="Proprietorship" <?php foreach ($arr_se as $employee_se){  if ($employee_se == 'Proprietorship'){ echo 'checked';} } ?>>Proprietorship
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="sbl_banker_account_nature[]" value="Current" <?php $n_sbl = explode(',', $editData->sbl_banker_account_nature); foreach ($n_sbl as $sbl_n){  if ($sbl_n == 'Current'){ echo 'checked';} } ?>>Current
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" class="datepicker form-control" data-date-format="dd/mm/yyyy" name="travel_date" id="date2" autocomplete="off" placeholder="Date of Travel" value="<?php if ($editData->travel_date != 0000-00-00){ echo date('d-m-Y', strtotime($editData->travel_date)); }  ?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="refer_id" style="width: 100%;">
                                                            ...
                                                            <option value="<?php echo $refer->refer_id; ?>" <?php if ($editData->refer_id == $refer->refer_id){ echo 'selected'; } ?>><?php echo $refer->refer_id.' - '.$refer->name.' - '.$refer->ivac_id; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6"><input type="hidden" name="id" value="<?php echo $editData->id ?>" ></div>
                                        <div class="col-md-6">
