...
@section('page-content')
            ...
            <table  width="100%">
                ...
                <tr>
                    ...
                    <td style="font-size: 12px;padding: 5px; height: 600px !important;" width="33%">
                        ...
                        <p style="padding-top: 10px;line-height: 0.8em">x
                        ...
                        <p style="margin: 0px !important;" >Signature of the authorized official   &nbsp;&nbsp;-----------------------------</p>
                        <p style="margin: 0px !important;padding: 0px;" ><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Date:<span style="border: 1px solid #ddd;padding-right: 13px;"><?php echo date('d-m-Y', strtotime($print_data->created_date)); ?></span></p>
                        ...
                        <p style="margin: 0px !important;padding: 0px;line-height: 1em" ><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Date:<span style="border: 1px solid #ddd;padding-right: 13px;"><?php echo date('d-m-Y', strtotime($print_data->created_date)); ?></span></p>
                    </td>
                    <td style="font-size: 13px;padding: 5px;" width="33%">
                        <img src="{{asset('public/assets/img/SBI.png')}}" style="width: 300px; height: 660px; !important">
                    </td>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="font-size: 12px; padding: 5px;"  width="33%">
                        ...
                        <p style="margin: 4px !important;" >Date of Birth of the Applicant: <span style="border: 1px solid #ddd;padding-right: 20px;padding-left: 3px;"><?php if ($print_data->a_birth != 0000-00-00){ echo date('d-m-Y', strtotime($print_data->a_birth)); }  ?></span></p>
    ...
    <script>
        ...
        $(window).on('afterprint', function () {
            window.location.href="{{ url("/dollar_endorsement/edit/$id") }}";
        });
        <?php } ?>
    </script>
    <script>
