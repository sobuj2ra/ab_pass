...
<!--Page Header-->
@section('page-header')
    Dollar Endorsement Referred Details Report
@endsection
                ...
                <div class="main_part">
                    ...
                    <div class="change_passport_body">
                        <p class="form_title_center">
                            <i>Dollar Endorsement Details Referred Report</i>
                        </p>
                        <form action="{{ URL::to('dollar-referred-report-search') }}" method="post" target="_blank">
                            {{ csrf_field() }}
