...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">R.A.P/ P.A.P</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
 ...
 {!! Form::open(['url' => 'rap/pap/save','id' => 'applicant_form']) !!}
          ...
          <div class="form-group">
            ...
            <div id="routeDiv">
              ...
              <label style="font-weight:normal;cursor: pointer;">  <input type="checkbox" name="route" value=" {{$routes_value->route_name}}"/> {{$routes_value->route_name}}</label>
              </li>
              </ul>
              @endforeach
            ...
            <div id="areaDiv">
              ...
              <ul class="list-group" style="margin:0;padding: 0;">
              <li style="list-style-type:none;padding:0;margin:0;">
              <label style="font-weight:normal;cursor: pointer;">  <input type="checkbox" name="route" value="{{$port_value->port_name}}"/> {{$port_value->port_name}}</label>
              </li>
              </ul>
              @endforeach
              <p class="areafield"></p>
            ...
            <div class="row">             
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-6">
                    <div class="row">
                       <div class="col-sm-6">
                          <input type="date" name="arrivalDate" id="dt" class="form-control" onchange="mydate1();" required="required" />
                       </div>
             <div class="col-sm-6"><input type="date" name="derpartureDate" id="dt" class="form-control" required="required" onchange="mydate2();"></div>
                    </div>
                </div>
            </div>
...
<div class="control-group after-add-more">
     <div class="row">
        <div class="col-md-2"> 
            <div style="float:left;width:100px;"><input type="text" name="passportNo[]" class="form-control" required="required" placeholder="P.P. No"></div><div style="float:right;width:42px;margin-top:5px;"> <label style="font-weight:normal;"> <input type="radio" checked="checked" value="1" name="master_passport"> M.P</label></div>
        </div>
        <div class="col-md-2"> 
            <input type="text" name="visa_no[]" required="required" class="form-control" placeholder="Visa No">
        </div>
        <div class="col-md-2">
           <div style="float:left;"><input type="text" required="required" style="width:70px;" name="stickerNo[]" class="form-control" placeholder="Stic.No"></div><div style="float:right;"><input  style="width:70px;" type="text" name="fee[]" class="form-control" placeholder="Fee"> </div>
        </div>
        <div class="col-md-2"> 
            <input type="text" name="applicant_name" required="required" class="form-control" placeholder="Applicant Name"></div>
        <div class="col-md-2">   
            <div class="form-group">
        ...
        <div class="col-md-2"> <input type="text" required="required" name="contactNo" class="form-control" placeholder="Contact No"></div>
     </div>     
 <div class="row">
      <!--<div class="col-md-2"></div>-->
       <div class="col-sm-2"  style="float:right;text-align: right;"> 
        ...
        <div class="col-md-2"> 
            <input type="text" name="applicant_name1" class="form-control" placeholder="Applicant Name"></div>
        <div class="col-md-2">   
            <div class="form-group">
                <select class="form-control" name="visaType1">
                     <option value="">-- Visa Type --</option>
                    @foreach($visatype as $visatype_value)
                     <option value="{{$visatype_value->visa_type}}">{{$visatype_value->visa_type}}</option>
                     @endforeach
        ...
        <div class="col-md-2"> <input type="text" name="contactNo1" class="form-control" placeholder="Contact No"></div>
     </div>     
                        <div class="row">                         
                            <div class="col-md-12">
...
//Form submit start
$("#applicant_formd").submit(function(event){
