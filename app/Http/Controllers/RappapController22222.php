...
class RappapController extends Controller
{
    ...
    public function save(Request $request){
        ...
        // echo "<div class='btn btn-success pull-right'>Application form has submitted Successfully</div>";


        //*********************************************************//
        // After Save Redirection to Main Controller with Message
        //********************************************************//
    ...
    public function report_detail(Request $request)
    {
        ...
        return view('rappap.rappapdetail', ['rappap_detail' => $rappap_receive_detail, 'fromdate'=>$fromDate,'todate'=>$toDate]);
    }
...
//SELECT DISTINCT date( `rec_cen_time`), `rec_cen_by` FROM `tbl_port_update` WHERE `rec_cen_by`='Admin' AND date(rec_cen_time) BETWEEN '2019-01-19' AND '2019-01-19'
        ...
        $sql = "SELECT DISTINCT date(`rec_cen_time`) as rd, `rec_cen_by` FROM tbl_port_update";
        $con1= " WHERE center='$centerName'";
        $con2= " AND date(rec_cen_time) BETWEEN '$fromDate' AND '$toDate'";
        $con3= " WHERE date(rec_cen_time) BETWEEN '$fromDate' AND '$toDate'";
        // $con4= " ";
...
//print_r($tmp);
    ...
    public function approvedetail(Request $request){
        ...
        return view('rappap.approvedetail' , ['details'=>$rappap_approve_detail,  'fromDate'=>$fromDate,'toDate'=>$toDate ]);
    }
...
//print_r($passportdataSet);
    ...
    public static function delivery_date()
    {
        ...
        //$newDate=date('Y-m-d', strtotime($reciveDate . " + $leadDate day"));
